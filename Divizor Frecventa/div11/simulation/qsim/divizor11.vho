...
-- Design Ports Information
-- q0	=>  Location: PIN_32,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- q1	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- q2	=>  Location: PIN_34,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- q3	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- pin_name1	=>  Location: PIN_23,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF divizor11 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst1~0_combout\ = (\inst1~q\ & (!\inst3~q\ & !\inst~q\)) # (!\inst1~q\ & ((\inst~q\)))
...
-- Equation(s):
-- \inst3~0_combout\ = (\inst3~q\ & (((!\inst1~q\)))) # (!\inst3~q\ & (\inst~q\ & (\inst2~q\ & \inst1~q\)))
...
-- Equation(s):
-- \inst~0_combout\ = (!\inst~q\ & ((!\inst1~q\) # (!\inst3~q\)))
