...
ARCHITECTURE structure OF num6invers IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst2~0_combout\ = (\inst2~q\ & ((\inst~q\))) # (!\inst2~q\ & (!\inst1~q\ & !\inst~q\))
...
-- Equation(s):
-- \inst1~0_combout\ = (\inst~q\ & (\inst1~q\)) # (!\inst~q\ & (!\inst1~q\ & \inst2~q\))
